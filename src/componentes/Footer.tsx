      ...
      <footer className="flex justify-center items-center w-full bg-[#241E20] h-52">
        <div className="flex flex-col justify-center items-center mb-3">
          ...
          <section className="flex mt-2">
            {/* Facebook Icon */}
            <a
              href="https://www.facebook.com/Sal%C3%A3o-de-Cabeleireira-Terezinha-101560624919091/"
            ...
            {/* Instagram Icon */}
            <a
              href="https://www.instagram.com/ritual_terezinha/"
              className="icon_container"
            >
            ...
            {/* WhatsApp Icon */}
            <a
              href="https://api.whatsapp.com/send?phone=00351919524245"
              className="icon_container"
            >
